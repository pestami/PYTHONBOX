...
##    cv2.rectangle(grey_img_2,(20,20),(180,180),(0,255,0),3)
    ...
    cv2.circle(grey_img_2,MountingFrame[0], 5, (0,0,255),4) #BGR
    cv2.circle(grey_img_2,MountingFrame[1], 5, (0,0,255),4)
    cv2.circle(grey_img_2,MountingFrame[2], 5, (0,0,255),4)
    cv2.circle(grey_img_2,MountingFrame[3], 5, (0,0,255),4)
    cv2.circle(grey_img_2,MountingFrame[4], 5, (0,0,255),4)
...
##        cv2.circle(grey_img_2,MountingFrame[3], 5, (0,0,255),1)
    ...
    for POINT in MP_WORLD:
        try:
            cv2.circle(grey_img_2,(int(POINT[1]),int(POINT[2])), 10, (100,100,0),6)
##            print("",POINT)
        except:
##            print("Not integfer",POINT)
    ...
    cv2.circle(grey_img_2,(X2[1],Y2[1]), 10, (0,255,0),6)
